...
_G.packer_plugins = {
  YouCompleteMe = {
    config = { "require('plugins-config/YouCompleteMe')" },
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/YouCompleteMe",
    url = "https://github.com/ycm-core/YouCompleteMe"
  },
  ["auto-pairs"] = {
    config = { "require('plugins-config/auto-pairs')" },
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  ["nvim-dap-python"] = {
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/nvim-dap-python",
    url = "https://github.com/mfussenegger/nvim-dap-python"
  },
  ["nvim-dap-ui"] = {
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/nvim-dap-ui",
  ...
  ["vim-airline"] = {
    config = { "require('plugins-config/vim-airline')" },
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-commentary"] = {
    config = { "require('plugins-config/vim-commentary')" },
    loaded = true,
  ...
  ["vim-markdown"] = {
    ...
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/vim-markdown",
  ...
  ["vim-table-mode"] = {
    config = { "require('plugins-config/vim-table-mode')" },
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/vim-table-mode",
    url = "https://github.com/dhruvasagar/vim-table-mode"
  },
  vimtex = {
    config = { "require('plugins-config/latex')" },
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/vimtex",
...
time([[Config for YouCompleteMe]], true)
require('plugins-config/YouCompleteMe')
time([[Config for YouCompleteMe]], false)
